...
-- Three weeks of attendance for the Aptitude class, varied so the % looks real
INSERT INTO attendance (student_id, class_assignment_id, date, status, marked_by) VALUES
  ('22222222-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000001', '2026-07-08', 'present', '11111111-0000-0000-0000-000000000003'),
  ('22222222-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000001', '2026-07-15', 'present', '11111111-0000-0000-0000-000000000003'),
  ('22222222-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000001', '2026-07-22', 'absent',  '11111111-0000-0000-0000-000000000003'),
  ('22222222-0000-0000-0000-000000000002', '33333333-0000-0000-0000-000000000001', '2026-07-08', 'present', '11111111-0000-0000-0000-000000000003'),
  ('22222222-0000-0000-0000-000000000002', '33333333-0000-0000-0000-000000000001', '2026-07-15', 'absent',  '11111111-0000-0000-0000-000000000003'),
  ('22222222-0000-0000-0000-000000000002', '33333333-0000-0000-0000-000000000001', '2026-07-22', 'present', '11111111-0000-0000-0000-000000000003'),
  ('22222222-0000-0000-0000-000000000003', '33333333-0000-0000-0000-000000000001', '2026-07-08', 'present', '11111111-0000-0000-0000-000000000003'),
  ('22222222-0000-0000-0000-000000000003', '33333333-0000-0000-0000-000000000001', '2026-07-15', 'present', '11111111-0000-0000-0000-000000000003'),
  ('22222222-0000-0000-0000-000000000003', '33333333-0000-0000-0000-000000000001', '2026-07-22', 'excused', '11111111-0000-0000-0000-000000000003');
